...
7.  Update to RFC 4035
   ...
   | resolvers SHOULD use wildcards and NSEC/NSEC3 resource       |
   | records to generate (positive and) negative responses until  |
   | their effective TTLs or signatures for those records expire. |
   +--------------------------------------------------------------+
